...
public abstract class Hilt_FavouriteScreen extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavouriteScreen() {
    super();
  }

  Hilt_FavouriteScreen(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavouriteScreen_GeneratedInjector) this.generatedComponent()).injectFavouriteScreen(UnsafeCasts.<FavouriteScreen>unsafeCast(this));
    }
  }
