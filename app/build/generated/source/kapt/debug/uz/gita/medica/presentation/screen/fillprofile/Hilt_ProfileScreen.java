...
public abstract class Hilt_ProfileScreen extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProfileScreen(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProfileScreen_GeneratedInjector) this.generatedComponent()).injectProfileScreen(UnsafeCasts.<ProfileScreen>unsafeCast(this));
    }
  }
