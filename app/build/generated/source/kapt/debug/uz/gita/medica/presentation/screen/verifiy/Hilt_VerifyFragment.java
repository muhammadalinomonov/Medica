...
public abstract class Hilt_VerifyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VerifyFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VerifyFragment_GeneratedInjector) this.generatedComponent()).injectVerifyFragment(UnsafeCasts.<VerifyFragment>unsafeCast(this));
    }
  }
