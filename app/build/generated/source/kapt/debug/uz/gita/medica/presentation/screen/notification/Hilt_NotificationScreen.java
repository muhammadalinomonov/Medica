...
public abstract class Hilt_NotificationScreen extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NotificationScreen() {
    super();
  }

  Hilt_NotificationScreen(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NotificationScreen_GeneratedInjector) this.generatedComponent()).injectNotificationScreen(UnsafeCasts.<NotificationScreen>unsafeCast(this));
    }
  }
