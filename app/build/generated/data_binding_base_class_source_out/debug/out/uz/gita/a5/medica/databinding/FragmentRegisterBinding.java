...
public final class FragmentRegisterBinding implements ViewBinding {
  ...
  @NonNull
  public final AppCompatButton logn;

  @NonNull
  public final TextView sign;

  private FragmentRegisterBinding(@NonNull ConstraintLayout rootView, @NonNull View divider,
      @NonNull View divider1, @NonNull ImageView image, @NonNull TextView letsyouin,
      @NonNull AppCompatButton logn, @NonNull TextView sign) {
  ...
  public static FragmentRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.logn;
      AppCompatButton logn = ViewBindings.findChildViewById(rootView, id);
      if (logn == null) {
        break missingId;
      }
      ...
      return new FragmentRegisterBinding((ConstraintLayout) rootView, divider, divider1, image,
          letsyouin, logn, sign);
    }
